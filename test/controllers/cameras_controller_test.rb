...
class CamerasControllerTest < ActionController::TestCase
  ...
  test "should create camera" do
    assert_difference('Camera.count') do
      post :create, camera: { available: @camera.available, file: @camera.file, lat: @camera.lat, lng: @camera.lng, location: @camera.location, postcode: @camera.postcode }
    end
  ...
  test "should update camera" do
    patch :update, id: @camera, camera: { available: @camera.available, file: @camera.file, lat: @camera.lat, lng: @camera.lng, location: @camera.location, postcode: @camera.postcode }
    assert_redirected_to camera_path(assigns(:camera))
  end
